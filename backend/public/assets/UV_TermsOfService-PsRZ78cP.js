import{j as e}from"./state-vendor-__gb9IU9.js";import{e as B,u as k,r,L as c}from"./react-vendor-QYi6USC3.js";import{u as w}from"./index-CWUh35PH.js";import{F as D,an as R,f as S,h as O}from"./ui-vendor-CuJPReAW.js";const L={title:"Terms of Service",version:"1.0",effective_date:"2024-01-01",last_updated:"2024-01-01T00:00:00Z",sections:[{id:"introduction",title:"1. Introduction and Acceptance",content:`
      ...
      `,subsections:[]}]},Y=()=>{const[p,T]=B(),N=k(),o=w(t=>t.authentication_state.authentication_status.is_authenticated),d=w(t=>t.authentication_state.current_user),[a]=r.useState(L),[s,h]=r.useState(p.get("section")||"introduction"),[E,P]=r.useState([]),[u,y]=r.useState({accepted:!1,acceptance_date:null,version_accepted:null}),[f]=r.useState(!1),[m]=r.useState(null),[j,g]=r.useState(!1),[b,v]=r.useState(!1),n=r.useRef({});r.useEffect(()=>{const t=a.sections.map(i=>({section_id:i.id,title:i.title,subsections:i.subsections.map(l=>({id:l.id,title:l.title}))}));if(P(t),o&&d){const i=localStorage.getItem(`terms_acceptance_${d.user_id}`);if(i){const l=JSON.parse(i);y(l)}}},[a,o,d]),r.useEffect(()=>{const t=p.get("section");t&&t!==s&&h(t)},[p,s]),r.useEffect(()=>{s&&n.current[s]&&setTimeout(()=>{var t;(t=n.current[s])==null||t.scrollIntoView({behavior:"smooth",block:"start"})},100)},[s]);const x=t=>{var i;h(t),T({section:t}),v(!1),n.current[t]&&((i=n.current[t])==null||i.scrollIntoView({behavior:"smooth",block:"start"}))},A=()=>{if(!o||!d){N("/login?redirect_url=/terms");return}const t={accepted:!0,acceptance_date:new Date().toISOString(),version_accepted:a.version};localStorage.setItem(`terms_acceptance_${d.user_id}`,JSON.stringify(t)),y(t),g(!0),setTimeout(()=>{g(!1)},5e3)},I=()=>{alert("PDF download will be available soon. This feature requires backend implementation.")},C=t=>{console.log(`Section viewed: ${t} at ${new Date().toISOString()}`)};return e.jsx(e.Fragment,{children:e.jsxs("div",{className:"min-h-screen bg-gray-50",children:[e.jsx("div",{className:"bg-white border-b border-gray-200",children:e.jsxs("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex-1",children:[e.jsxs("div",{className:"flex items-center space-x-3 mb-2",children:[e.jsx(D,{className:"w-8 h-8 text-blue-600"}),e.jsx("h1",{className:"text-3xl font-bold text-gray-900",children:a.title})]}),e.jsxs("div",{className:"flex items-center space-x-4 text-sm text-gray-600",children:[e.jsxs("span",{children:["Version ",a.version]}),e.jsx("span",{children:"•"}),e.jsxs("span",{children:["Effective Date: ",new Date(a.effective_date).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})]}),e.jsx("span",{children:"•"}),e.jsxs("span",{children:["Last Updated: ",new Date(a.last_updated).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})]})]})]}),e.jsxs("div",{className:"flex items-center space-x-4",children:[e.jsxs("button",{onClick:I,className:"flex items-center space-x-2 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors",children:[e.jsx(R,{className:"w-4 h-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Download PDF"})]}),e.jsx("button",{onClick:()=>v(!b),className:"lg:hidden px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50",children:e.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 6h16M4 12h16M4 18h16"})})})]})]}),o&&u.accepted&&e.jsx("div",{className:"mt-4 bg-green-50 border border-green-200 rounded-lg p-4",children:e.jsxs("div",{className:"flex items-center space-x-2",children:[e.jsx(S,{className:"w-5 h-5 text-green-600"}),e.jsxs("p",{className:"text-sm text-green-800",children:["You accepted these terms on ",new Date(u.acceptance_date).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}),u.version_accepted&&` (Version ${u.version_accepted})`]})]})}),j&&e.jsx("div",{className:"mt-4 bg-green-50 border border-green-200 rounded-lg p-4 animate-fade-in",children:e.jsxs("div",{className:"flex items-center space-x-2",children:[e.jsx(S,{className:"w-5 h-5 text-green-600"}),e.jsx("p",{className:"text-sm text-green-800 font-medium",children:"Thank you for accepting our Terms of Service!"})]})})]})}),e.jsx("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8",children:e.jsxs("div",{className:"flex flex-col lg:flex-row gap-8",children:[e.jsx("aside",{className:`lg:w-80 ${b?"block":"hidden lg:block"}`,children:e.jsxs("div",{className:"sticky top-24 bg-white rounded-lg shadow-lg border border-gray-200 p-6",children:[e.jsx("h2",{className:"text-lg font-bold text-gray-900 mb-4",children:"Table of Contents"}),e.jsx("nav",{className:"space-y-1",children:E.map(t=>e.jsxs("div",{children:[e.jsx("button",{onClick:()=>x(t.section_id),className:`w-full text-left px-3 py-2 rounded-md text-sm font-medium transition-colors ${s===t.section_id?"bg-blue-50 text-blue-700 border-l-4 border-blue-600":"text-gray-700 hover:bg-gray-50 border-l-4 border-transparent"}`,children:t.title}),t.subsections.length>0&&s===t.section_id&&e.jsx("div",{className:"ml-4 mt-1 space-y-1",children:t.subsections.map(i=>e.jsx("button",{onClick:()=>x(i.id),className:"w-full text-left px-3 py-1 text-xs text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-md",children:i.title},i.id))})]},t.section_id))}),e.jsxs("div",{className:"mt-6 pt-6 border-t border-gray-200",children:[e.jsx("h3",{className:"text-sm font-semibold text-gray-900 mb-3",children:"Related Documents"}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(c,{to:"/privacy",className:"block text-sm text-blue-600 hover:text-blue-700 hover:underline",children:"Privacy Policy →"}),e.jsx(c,{to:"/help",className:"block text-sm text-blue-600 hover:text-blue-700 hover:underline",children:"Help Center →"}),e.jsx(c,{to:"/contact",className:"block text-sm text-blue-600 hover:text-blue-700 hover:underline",children:"Contact Us →"})]})]})]})}),e.jsxs("main",{className:"flex-1 bg-white rounded-lg shadow-lg border border-gray-200 p-8 lg:p-12",children:[m&&e.jsx("div",{className:"mb-6 bg-red-50 border border-red-200 rounded-lg p-4",children:e.jsxs("div",{className:"flex items-center space-x-2",children:[e.jsx(O,{className:"w-5 h-5 text-red-600"}),e.jsx("p",{className:"text-sm text-red-800",children:m})]})}),f&&e.jsx("div",{className:"flex items-center justify-center py-12",children:e.jsx("div",{className:"animate-spin rounded-full h-12 w-12 border-b-4 border-blue-600"})}),!f&&!m&&e.jsxs("div",{className:"prose prose-lg prose-blue max-w-none",children:[a.sections.map(t=>e.jsxs("section",{id:t.id,ref:i=>{n.current[t.id]=i},className:`mb-12 scroll-mt-24 ${s===t.id?"ring-2 ring-blue-200 ring-offset-4 rounded-lg p-4 -m-4":""}`,onMouseEnter:()=>C(t.id),children:[e.jsx("h2",{className:"text-2xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-gray-200",children:t.title}),e.jsx("div",{className:"text-gray-700 leading-relaxed",dangerouslySetInnerHTML:{__html:t.content}}),t.subsections.map(i=>e.jsxs("div",{id:i.id,ref:l=>{n.current[i.id]=l},className:"mt-6",children:[e.jsx("h3",{className:"text-xl font-semibold text-gray-800 mb-3",children:i.title}),e.jsx("div",{className:"text-gray-700",dangerouslySetInnerHTML:{__html:i.content}})]},i.id))]},t.id)),e.jsxs("section",{className:"mt-12 pt-8 border-t-2 border-gray-300",children:[e.jsx("h2",{className:"text-2xl font-bold text-gray-900 mb-4",children:"Acknowledgment"}),e.jsx("p",{className:"text-gray-700 mb-6",children:'BY CLICKING "I ACCEPT" BELOW OR BY CONTINUING TO USE THE BUILDEASY PLATFORM, YOU ACKNOWLEDGE THAT YOU HAVE READ, UNDERSTOOD, AND AGREE TO BE BOUND BY THESE TERMS OF SERVICE.'}),o&&!u.accepted&&e.jsxs("div",{className:"bg-blue-50 border border-blue-200 rounded-lg p-6",children:[e.jsx("p",{className:"text-gray-800 mb-4",children:"Please accept these Terms of Service to continue using BuildEasy."}),e.jsx("button",{onClick:A,className:"w-full sm:w-auto px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl",children:"I Accept the Terms of Service"})]}),!o&&e.jsxs("div",{className:"bg-gray-50 border border-gray-200 rounded-lg p-6",children:[e.jsx("p",{className:"text-gray-700 mb-4",children:"To accept these terms and use BuildEasy, please sign in or create an account."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-3",children:[e.jsx(c,{to:"/login?redirect_url=/terms",className:"px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors text-center",children:"Sign In"}),e.jsx(c,{to:"/register?redirect_url=/terms",className:"px-6 py-3 bg-white border-2 border-blue-600 text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transition-colors text-center",children:"Create Account"})]})]})]}),e.jsxs("section",{className:"mt-12 pt-8 border-t border-gray-200",children:[e.jsx("h2",{className:"text-xl font-bold text-gray-900 mb-4",children:"Questions About These Terms?"}),e.jsx("p",{className:"text-gray-700 mb-4",children:"If you have any questions or concerns about these Terms of Service, please don't hesitate to contact us:"}),e.jsxs("div",{className:"bg-gray-50 rounded-lg p-6 space-y-2",children:[e.jsxs("p",{className:"text-gray-800",children:[e.jsx("strong",{children:"Email:"})," ",e.jsx("a",{href:"mailto:legal@buildeasy.com",className:"text-blue-600 hover:text-blue-700 underline",children:"legal@buildeasy.com"})]}),e.jsxs("p",{className:"text-gray-800",children:[e.jsx("strong",{children:"Phone:"})," ",e.jsx("a",{href:"tel:1-800-BUILD-EZ",className:"text-blue-600 hover:text-blue-700 underline",children:"1-800-BUILD-EZ"})]}),e.jsxs("p",{className:"text-gray-800",children:[e.jsx("strong",{children:"Support:"})," ",e.jsx(c,{to:"/support",className:"text-blue-600 hover:text-blue-700 underline",children:"Visit our Support Center"})]})]})]})]})]})]})}),e.jsx("button",{onClick:()=>window.scrollTo({top:0,behavior:"smooth"}),className:"fixed bottom-8 right-8 bg-blue-600 text-white p-3 rounded-full shadow-lg hover:bg-blue-700 transition-all hover:scale-110 hidden lg:block","aria-label":"Scroll to top",children:e.jsx("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M5 10l7-7m0 0l7 7m-7-7v18"})})})]})})};export{Y as default};
