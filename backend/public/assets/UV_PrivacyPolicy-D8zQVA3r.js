import{j as e}from"./state-vendor-__gb9IU9.js";import{e as F,r as n,L as f}from"./react-vendor-QYi6USC3.js";import{u as z}from"./index-CrNOa18y.js";import{j as L,F as g,Y as P,an as U,h as N,p as k,K as B,b3 as M}from"./ui-vendor-CuJPReAW.js";const O={title:"Privacy Policy",version:"1.0",effective_date:"2024-01-15",last_updated:"2024-01-15",gdpr_compliant:!0,ccpa_compliant:!0,sections:[{id:"overview",title:"Privacy Policy Overview",content:`Welcome to BuildEasy. This Privacy Policy explains how BuildEasy, Inc. ("BuildEasy," "we," "us," or "our") collects, uses, discloses, and protects your personal information when you use our construction supply marketplace platform, including our website, mobile applications, and related services (collectively, the "Services").
...
BuildEasy does not sell personal information to third parties for monetary or other valuable consideration. We may share information with service providers and partners as described in this Privacy Policy, but such sharing does not constitute a "sale" under CCPA.`}]},H=()=>{const[S,C]=F(),c=S.get("section")||"overview",[i]=n.useState(O),[x,y]=n.useState(c),[b,m]=n.useState(null),[_,D]=n.useState(!1),[s,R]=n.useState({analytics_consent:!1,marketing_consent:!1,personalization_consent:!1,data_sharing_consent:!1,last_updated:null}),[o,d]=n.useState({export_requested:!1,export_status:null,deletion_requested:!1,deletion_status:null}),v={gdpr:i.gdpr_compliant,ccpa:i.ccpa_compliant},A=i.sections.map(t=>{var r;return{section_id:t.id,title:t.title,subsections:((r=t.subsections)==null?void 0:r.map(a=>({id:a.id,title:a.title})))||[]}}),u=z(t=>t.authentication_state.authentication_status.is_authenticated),l=n.useRef({});n.useEffect(()=>{y(c),l.current[c]&&setTimeout(()=>{var t;(t=l.current[c])==null||t.scrollIntoView({behavior:"smooth",block:"start"})},100)},[c]),n.useEffect(()=>{const t=()=>{D(window.scrollY>400);const r=window.scrollY+100;for(const a of i.sections){const h=l.current[a.id];if(h){const{offsetTop:j,offsetHeight:W}=h;if(r>=j&&r<j+W){y(a.id);break}}}};return window.addEventListener("scroll",t),()=>window.removeEventListener("scroll",t)},[i.sections]);const w=t=>{C({section:t}),y(t);const r=l.current[t];r&&r.scrollIntoView({behavior:"smooth",block:"start"})},q=()=>{window.scrollTo({top:0,behavior:"smooth"})},p=async(t,r)=>{if(!u)return;const a={...s,[t]:r,last_updated:new Date().toISOString()};R(a);try{console.log("Privacy preferences updated (API endpoint not available):",a)}catch(h){console.error("Failed to update privacy preferences:",h),m("Failed to update privacy preferences. Please try again.")}},T=async()=>{if(u){d(t=>({...t,export_requested:!0,export_status:"processing"}));try{console.log("Data export requested (API endpoint not available)"),setTimeout(()=>{d(t=>({...t,export_status:"completed"})),alert("Data export request received. You will receive a download link via email within 48 hours.")},1e3)}catch(t){console.error("Failed to request data export:",t),d(r=>({...r,export_status:"failed"})),m("Failed to request data export. Please try again or contact support.")}}},E=async()=>{if(!(!u||!window.confirm("Are you sure you want to delete your account? This action cannot be undone. All your data, including order history and reviews, will be permanently deleted."))){d(r=>({...r,deletion_requested:!0,deletion_status:"pending_verification"}));try{console.log("Account deletion requested (API endpoint not available)"),alert("Account deletion request received. You will receive a verification email to confirm this request within 24 hours.")}catch(r){console.error("Failed to request account deletion:",r),d(a=>({...a,deletion_status:"failed"})),m("Failed to request account deletion. Please contact support at privacy@buildeasy.com.")}}},I=()=>{alert("PDF download feature is coming soon. For now, you can print this page using your browser's print function (Ctrl+P or Cmd+P).")};return e.jsx(e.Fragment,{children:e.jsxs("div",{className:"min-h-screen bg-gray-50",children:[e.jsx("div",{className:"bg-gradient-to-br from-blue-50 to-indigo-100 border-b border-gray-200",children:e.jsx("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"flex justify-center mb-4",children:e.jsx(L,{className:"h-16 w-16 text-blue-600"})}),e.jsx("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:i.title}),e.jsxs("div",{className:"flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-6 text-sm text-gray-600",children:[e.jsxs("div",{className:"flex items-center",children:[e.jsx(g,{className:"h-4 w-4 mr-2"}),e.jsxs("span",{children:["Version ",i.version]})]}),e.jsxs("div",{children:[e.jsx("span",{className:"font-medium",children:"Effective Date:"})," ",new Date(i.effective_date).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})]}),e.jsxs("div",{children:[e.jsx("span",{className:"font-medium",children:"Last Updated:"})," ",new Date(i.last_updated).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})]})]}),e.jsxs("div",{className:"flex flex-wrap justify-center gap-3 mt-6",children:[v.gdpr&&e.jsxs("div",{className:"flex items-center bg-green-50 border border-green-200 text-green-700 px-4 py-2 rounded-full text-sm font-medium",children:[e.jsx(P,{className:"h-4 w-4 mr-2"}),"GDPR Compliant"]}),v.ccpa&&e.jsxs("div",{className:"flex items-center bg-green-50 border border-green-200 text-green-700 px-4 py-2 rounded-full text-sm font-medium",children:[e.jsx(P,{className:"h-4 w-4 mr-2"}),"CCPA Compliant"]})]}),e.jsx("div",{className:"mt-6",children:e.jsxs("button",{onClick:I,className:"inline-flex items-center px-6 py-3 bg-white text-gray-700 border border-gray-300 rounded-lg font-medium hover:bg-gray-50 transition-all duration-200 shadow-sm",children:[e.jsx(U,{className:"h-5 w-5 mr-2"}),"Download as PDF"]})})]})})}),e.jsx("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-4 gap-8",children:[e.jsx("aside",{className:"hidden lg:block lg:col-span-1",children:e.jsxs("div",{className:"sticky top-24 bg-white rounded-xl shadow-lg border border-gray-100 p-6",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-900 mb-4",children:"Table of Contents"}),e.jsx("nav",{className:"space-y-1",children:A.map(t=>e.jsxs("div",{children:[e.jsx("button",{onClick:()=>w(t.section_id),className:`w-full text-left px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${x===t.section_id?"bg-blue-50 text-blue-700 border-l-4 border-blue-700":"text-gray-600 hover:bg-gray-50 hover:text-gray-900 border-l-4 border-transparent"}`,children:t.title}),t.subsections.length>0&&x===t.section_id&&e.jsx("div",{className:"ml-4 mt-1 space-y-1",children:t.subsections.map(r=>e.jsx("button",{onClick:()=>w(r.id),className:"w-full text-left px-3 py-1 text-xs text-gray-500 hover:text-blue-600",children:r.title},r.id))})]},t.section_id))})]})}),e.jsxs("div",{className:"lg:col-span-3 space-y-12",children:[e.jsx("div",{className:"bg-white rounded-xl shadow-lg border border-gray-100 p-8 lg:p-12",children:e.jsx("div",{className:"prose prose-lg max-w-none",children:i.sections.map(t=>e.jsxs("section",{id:t.id,ref:r=>{l.current[t.id]=r},className:"mb-16 scroll-mt-24",children:[e.jsx("h2",{className:"text-2xl font-semibold text-gray-900 mb-6 pb-3 border-b-2 border-gray-200",children:t.title}),e.jsx("div",{className:"text-base leading-relaxed text-gray-700 whitespace-pre-line mb-6",children:t.content}),t.subsections&&t.subsections.length>0&&e.jsx("div",{className:"space-y-8 ml-0 lg:ml-6",children:t.subsections.map(r=>e.jsxs("div",{id:r.id,ref:a=>{l.current[r.id]=a},className:"scroll-mt-24",children:[e.jsx("h3",{className:"text-xl font-medium text-gray-900 mb-4",children:r.title}),e.jsx("div",{className:"text-base leading-relaxed text-gray-600 whitespace-pre-line",children:r.content})]},r.id))})]},t.id))})}),u&&e.jsxs("div",{className:"bg-white rounded-xl shadow-lg border border-gray-100 p-8",children:[e.jsxs("div",{className:"border-b border-gray-200 pb-6 mb-6",children:[e.jsx("h2",{className:"text-2xl font-semibold text-gray-900 mb-2",children:"Your Privacy Preferences"}),e.jsx("p",{className:"text-sm text-gray-600",children:"Control how we use your data. Changes are saved automatically."})]}),e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"flex items-start justify-between",children:[e.jsxs("div",{className:"flex-1",children:[e.jsx("h3",{className:"text-base font-medium text-gray-900",children:"Analytics and Performance"}),e.jsx("p",{className:"text-sm text-gray-600 mt-1",children:"Allow us to collect anonymized usage data to improve our platform performance and user experience."})]}),e.jsx("button",{onClick:()=>p("analytics_consent",!s.analytics_consent),className:`ml-6 relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${s.analytics_consent?"bg-blue-600":"bg-gray-200"}`,role:"switch","aria-checked":s.analytics_consent,children:e.jsx("span",{className:`inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200 ${s.analytics_consent?"translate-x-5":"translate-x-0"}`})})]}),e.jsxs("div",{className:"flex items-start justify-between",children:[e.jsxs("div",{className:"flex-1",children:[e.jsx("h3",{className:"text-base font-medium text-gray-900",children:"Marketing Communications"}),e.jsx("p",{className:"text-sm text-gray-600 mt-1",children:"Receive personalized offers, promotions, and product recommendations via email."})]}),e.jsx("button",{onClick:()=>p("marketing_consent",!s.marketing_consent),className:`ml-6 relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${s.marketing_consent?"bg-blue-600":"bg-gray-200"}`,role:"switch","aria-checked":s.marketing_consent,children:e.jsx("span",{className:`inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200 ${s.marketing_consent?"translate-x-5":"translate-x-0"}`})})]}),e.jsxs("div",{className:"flex items-start justify-between",children:[e.jsxs("div",{className:"flex-1",children:[e.jsx("h3",{className:"text-base font-medium text-gray-900",children:"Personalization"}),e.jsx("p",{className:"text-sm text-gray-600 mt-1",children:"Use your browsing history and preferences to personalize product recommendations."})]}),e.jsx("button",{onClick:()=>p("personalization_consent",!s.personalization_consent),className:`ml-6 relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${s.personalization_consent?"bg-blue-600":"bg-gray-200"}`,role:"switch","aria-checked":s.personalization_consent,children:e.jsx("span",{className:`inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200 ${s.personalization_consent?"translate-x-5":"translate-x-0"}`})})]}),e.jsxs("div",{className:"flex items-start justify-between",children:[e.jsxs("div",{className:"flex-1",children:[e.jsx("h3",{className:"text-base font-medium text-gray-900",children:"Anonymized Data Sharing"}),e.jsx("p",{className:"text-sm text-gray-600 mt-1",children:"Allow sharing of anonymized data with suppliers for market analytics (no personal information shared)."})]}),e.jsx("button",{onClick:()=>p("data_sharing_consent",!s.data_sharing_consent),className:`ml-6 relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${s.data_sharing_consent?"bg-blue-600":"bg-gray-200"}`,role:"switch","aria-checked":s.data_sharing_consent,children:e.jsx("span",{className:`inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200 ${s.data_sharing_consent?"translate-x-5":"translate-x-0"}`})})]})]}),s.last_updated&&e.jsx("div",{className:"mt-6 pt-6 border-t border-gray-200",children:e.jsxs("p",{className:"text-xs text-gray-500",children:["Last updated: ",new Date(s.last_updated).toLocaleString()]})})]}),u&&e.jsxs("div",{className:"bg-white rounded-xl shadow-lg border border-gray-100 p-8",children:[e.jsxs("div",{className:"border-b border-gray-200 pb-6 mb-6",children:[e.jsx("h2",{className:"text-2xl font-semibold text-gray-900 mb-2",children:"Your Data Rights"}),e.jsx("p",{className:"text-sm text-gray-600",children:"Exercise your GDPR and CCPA rights to access, export, or delete your personal data."})]}),e.jsxs("div",{className:"space-y-6",children:[e.jsx("div",{className:"border border-gray-200 rounded-lg p-6",children:e.jsxs("div",{className:"flex items-start justify-between",children:[e.jsxs("div",{className:"flex-1",children:[e.jsx("h3",{className:"text-lg font-medium text-gray-900 mb-2",children:"Download Your Data"}),e.jsx("p",{className:"text-sm text-gray-600 mb-4",children:"Request a copy of all personal data we have about you. You'll receive a download link via email within 48 hours."}),o.export_requested&&e.jsx("div",{className:"mb-4",children:e.jsxs("span",{className:`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${o.export_status==="completed"?"bg-green-100 text-green-800":o.export_status==="processing"?"bg-blue-100 text-blue-800":"bg-red-100 text-red-800"}`,children:["Status: ",o.export_status||"Unknown"]})})]}),e.jsx("button",{onClick:T,disabled:o.export_requested&&o.export_status==="processing",className:"ml-4 px-6 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed",children:o.export_requested&&o.export_status==="processing"?"Processing...":"Request Data Export"})]})}),e.jsx("div",{className:"border border-red-200 bg-red-50 rounded-lg p-6",children:e.jsxs("div",{className:"flex items-start justify-between",children:[e.jsxs("div",{className:"flex-1",children:[e.jsxs("h3",{className:"text-lg font-medium text-red-900 mb-2 flex items-center",children:[e.jsx(N,{className:"h-5 w-5 mr-2"}),"Delete Your Account"]}),e.jsxs("p",{className:"text-sm text-red-700 mb-2",children:[e.jsx("strong",{children:"Warning:"})," This action cannot be undone. All your data, including order history, reviews, and saved items, will be permanently deleted."]}),e.jsx("p",{className:"text-sm text-red-600",children:"Outstanding orders must be completed or cancelled before account deletion."}),o.deletion_requested&&e.jsx("div",{className:"mt-4",children:e.jsxs("span",{className:"inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800",children:["Status: ",o.deletion_status||"Pending verification"]})})]}),e.jsx("button",{onClick:E,disabled:o.deletion_requested,className:"ml-4 px-6 py-3 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed",children:o.deletion_requested?"Request Sent":"Delete Account"})]})})]})]}),e.jsx("div",{className:"bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-200 p-8",children:e.jsxs("div",{className:"flex items-start",children:[e.jsx(k,{className:"h-6 w-6 text-blue-600 mt-1 mr-4"}),e.jsxs("div",{className:"flex-1",children:[e.jsx("h3",{className:"text-xl font-semibold text-gray-900 mb-2",children:"Questions About Privacy?"}),e.jsx("p",{className:"text-gray-700 mb-4",children:"Our Privacy Team is here to help. If you have questions about this policy or how we handle your data, please don't hesitate to reach out."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsxs("a",{href:"mailto:privacy@buildeasy.com",className:"inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-all duration-200",children:[e.jsx(k,{className:"h-5 w-5 mr-2"}),"Email Privacy Team"]}),e.jsxs(f,{to:"/contact",className:"inline-flex items-center px-6 py-3 bg-white text-gray-700 border border-gray-300 rounded-lg font-medium hover:bg-gray-50 transition-all duration-200",children:["Contact Support",e.jsx(B,{className:"h-5 w-5 ml-2"})]})]})]})]})}),e.jsxs("div",{className:"bg-white rounded-xl shadow-lg border border-gray-100 p-8",children:[e.jsx("h3",{className:"text-xl font-semibold text-gray-900 mb-6",children:"Related Legal Documents"}),e.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4",children:[e.jsxs(f,{to:"/terms",className:"flex items-center p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-all duration-200",children:[e.jsx(g,{className:"h-5 w-5 text-blue-600 mr-3"}),e.jsxs("div",{children:[e.jsx("div",{className:"font-medium text-gray-900",children:"Terms of Service"}),e.jsx("div",{className:"text-sm text-gray-600",children:"Platform usage terms"})]})]}),e.jsxs(f,{to:"/help",className:"flex items-center p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-all duration-200",children:[e.jsx(g,{className:"h-5 w-5 text-blue-600 mr-3"}),e.jsxs("div",{children:[e.jsx("div",{className:"font-medium text-gray-900",children:"Cookie Policy"}),e.jsx("div",{className:"text-sm text-gray-600",children:"How we use cookies"})]})]})]})]})]})]})}),_&&e.jsx("button",{onClick:q,className:"fixed bottom-8 right-8 p-4 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-all duration-200 hover:scale-110 focus:outline-none focus:ring-4 focus:ring-blue-100 z-50","aria-label":"Back to top",children:e.jsx(M,{className:"h-6 w-6"})}),b&&e.jsx("div",{className:"fixed top-20 right-4 max-w-md bg-red-50 border border-red-200 text-red-700 px-6 py-4 rounded-lg shadow-lg z-50",children:e.jsxs("div",{className:"flex items-start",children:[e.jsx(N,{className:"h-5 w-5 mr-3 flex-shrink-0 mt-0.5"}),e.jsx("div",{className:"flex-1",children:e.jsx("p",{className:"text-sm font-medium",children:b})}),e.jsx("button",{onClick:()=>m(null),className:"ml-4 text-red-700 hover:text-red-900",children:"×"})]})})]})})};export{H as default};
